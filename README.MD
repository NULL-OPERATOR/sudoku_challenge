...
*part 1: ruby*
----
setup a grid, logic, and general functionality of solving sudoku in isolation

*part 2: javascript*
----
export the logic into js, using selenium-webdriver/etc to solve online sudoku

*part 3: python*
----
switch the logic to python, keeping js for web functionality

*part 4: firefox*
----
set it up as a firefox plugin?


# Sudoku (original guide)
